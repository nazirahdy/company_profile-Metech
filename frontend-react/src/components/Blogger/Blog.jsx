  ...
  return (
    <section id="blog" className="py-3" style={{ backgroundColor: '#fdfdfd' }}>
      <div className="container py-4" data-aos="fade-up">
        ...
        <div className="row justify-content-center mb-5">
          <div className="col-md-7 text-center">
            ...
            <p className="text-muted">Recent posts from our Blog</p>
          </div>
        </div>
          ...
          blogs.length > 0 ? (
            <>
              <div className="row g-4">
                {/* Kita slice di sini menjadi 3 untuk tampilan grid */}
              ...
              {/* LOGIKA TOMBOL: Hanya muncul jika total data lebih dari 3 */}
              {blogs.length > 3 && (
            ...
            <div className="text-center py-4">
              <p className="text-muted">Belum ada postingan blog saat ini.</p>
            </div>
          )
        )}
      </div>
      ...
      <style>{`
        ...
        .btn-see-more { display: inline-block; padding: 14px 40px; border-radius: 50px; background: #00ced1; color: #fff; font-weight: 700; text-decoration: none; transition: all 0.3s ease; box-shadow: 0 10px 20px rgba(26, 26, 61, 0.15); }
        .btn-see-more:hover { background: #00ced1; color: #fff; transform: translateY(-3px); box-shadow: 0 15px 30px rgba(0, 206, 209, 0.25); text-decoration: none; }
      `}</style>
    </section>
  );
};
